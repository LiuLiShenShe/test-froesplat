# Instruction Card — HARD-ChangShouHua1-0238
...
- secondary: 背景杂乱
- raw-image difficulty score: 831.0
- Phase-15 排名: 
...
- 原始帧: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/ChangShouHua1/0238.jpg`
- 上下文前帧（可用）: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/ChangShouHua1/0233.jpg`
- 上下文后帧（可用）: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/ChangShouHua1/0243.jpg`
