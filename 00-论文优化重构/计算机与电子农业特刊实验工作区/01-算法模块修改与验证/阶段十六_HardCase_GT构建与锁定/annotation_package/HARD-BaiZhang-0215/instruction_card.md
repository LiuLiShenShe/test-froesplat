# Instruction Card — HARD-BaiZhang-0215
...
- secondary: 背景杂乱
- raw-image difficulty score: 0.6248
- Phase-15 排名: 25
...
- 原始帧: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/BaiZhang/0215.jpg`
- 上下文前帧（可用）: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/BaiZhang/0210.jpg`
- 上下文后帧（可用）: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/BaiZhang/0220.jpg`
- **GT 输出目录**: `/data/fj/F2DMAS/03-GT-区分_challenge/BaiZhang/`
