# Instruction Card — HARD-BaiZhang-0039
...
- 原始帧: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/BaiZhang/0039.jpg`
- 上下文前帧（可用）: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/BaiZhang/0034.jpg`
- 上下文后帧（可用）: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/BaiZhang/0044.jpg`
