# Instruction Card — HARD-DouBanLv2-0033
...
- 原始帧: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/DouBanLv2/0033.jpg`
- 上下文前帧（可用）: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/DouBanLv2/0028.jpg`
- 上下文后帧（可用）: `/data/fj/F2DMAS/00-论文优化重构/数据管理/01-输入图像/01-raw_frames/DouBanLv2/0038.jpg`
- **GT 输出目录**: `/data/fj/F2DMAS/03-GT-区分_challenge/DouBanLv2/`

## 尺寸
图像 3840×2160（高×宽，纵向；JSON 中 imageHeight=3840, imageWidth=2160），
shape_type=linestrip，`imagePath` 字段只填帧名如 `0033.jpg`。
