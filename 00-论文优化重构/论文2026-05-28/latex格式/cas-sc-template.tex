...
\author[1,3,4]{Nengfu Xie}
\cormark[1]

\author[2]{Yane Duan}
\cormark[1]

\author[1,3,4]{Jingchao Fan}
\author[1,3,4]{Xiaoli Wang}
\author[1,3,4]{Hailong Liu}
\author[1,3,4]{Yue Wang}
\author[1,3,4]{Hao Wu}
\author[1,3,4]{Zhibo Meng}
\author[1,3,4]{Xin Wang}
\author[1,3,4]{Rui Man}

\affiliation[1]{organization={Agricultural Information Institute, Chinese Academy of Agricultural Sciences},
            city={Beijing},
            postcode={100081},
            country={China}}

\affiliation[2]{organization={College of Intelligent Science and Engineering, Beijing University of Agriculture},
            city={Beijing},
            postcode={102206},
            country={China}}
...
\begin{keywords}
vision foundation model \sep promptable segmentation \sep SAM3 \sep 2D Gaussian Splatting \sep foreground-object reconstruction \sep plant phenotyping \sep RGB imaging
\end{keywords}
...
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig1-Overall framework of RAP-FSAM3-guided ForeSplat.png}}
...
\begin{figure}[pos=!htbp]
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig2-RAP-FSAM3_ reconstruction-aware prompt-adaptive foreground-prior generation.png}}
...
\begin{figure}[pos=!htbp]
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig3-Qualitative comparison of VFM-based plant foreground priors.png}}
...
\begin{figure}[pos=!htbp]
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig4-Prompt robustness and semantic-bias analysis.png}}
...
\begin{figure}[pos=!htbp]
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig5-VFM-prior injection into foreground-object 2DGS optimisation.png}}
...
\begin{figure}[pos=!htbp]
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig6-Micro-level M2M3-GO capacity optimisation across representative foreground morphologies.png}}
...
\begin{figure}[pos=!htbp]
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig7-Training-time VFM-prior injection is not equivalent to input masking or post hoc pruning.png}}
...
\begin{figure}[pos=!htbp]
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig8-Workflow-level reconstruction and mesh outputs.png}}
...
\begin{figure}[pos=!htbp]
\centering
\includegraphics[width=\textwidth,height=0.46\textheight,keepaspectratio]{\detokenize{Fig9-Manual--virtual phenotypic measurement agreement.png}}
...
The ForeSplat code, configuration templates and reproducibility scripts are available at \url{https://github.com/LiuLiShenShe/ForeSplat}. The repository is intended to document the workflow interface, including the expected input format, RAP-FSAM3 prompt and mask settings, view-quality weighting, M2M3-GO parameters, pruning configuration, training, mesh extraction, rendering evaluation and phenotypic measurement entry points. The full multiview RGB sequences, manually annotated foreground-prior evaluation frames, RAP-FSAM3 masks, phenotypic measurement tables, view-weight files and main running configurations supporting this study will be released through the project repository or a data repository after data curation is complete. Before public release, the data and configuration files are available from the corresponding author upon reasonable request.
